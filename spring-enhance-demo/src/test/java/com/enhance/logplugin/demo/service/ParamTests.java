...
public class ParamTests {
  ...
  @Ignore
  @Log(
      excludeInParam = {"arg2.name"},
      includeInParam = {"arg2.password"},
      param = {"user.name", "a", "bDto.id", "userDtos[1].password"})
  public void paramTest1(String a, BDto bDto, UserDto user, List<UserDto> userDtos) {
    ...
    log.info(
        "@Log(excludeInParam = {\"arg2.name\"}, includeInParam = {\"arg2.password\"}, param = {\"user.name\", \"a\", \"bDto.id\"})");
